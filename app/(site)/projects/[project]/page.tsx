    ...
    return (
        <div className='h-fit py-15'>
            <header className='flex justify-between items-center h-full pt-5'>
                ...
                <a title="Click Here to View Project" href={project.url} target='_blank' className='bg-gray-100 rounded-lg text-gray-500 font-bold py-3 px-4 whitespace-nowrap hover:bg-blue-500 hover:text-blue-100 transition mr-1'>
                    View Project
                </a>
            </header>
